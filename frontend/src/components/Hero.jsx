    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          >
            {/*
              Grid 2×2 sin escalonado.
              Todas las cards arrancan en la misma línea base,
              alineadas con el contenido izquierdo.
            */}
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              {[
                { icon: Headphones, titleKey: 'hero.card1Title', descKey: 'hero.card1Desc', gradient: 'from-[#04608E] to-[#1A4277]' },
                { icon: Users,      titleKey: 'hero.card2Title', descKey: 'hero.card2Desc', gradient: 'from-[#1EC2D7] to-[#04608E]' },
                { icon: Shield,     titleKey: 'hero.card3Title', descKey: 'hero.card3Desc', gradient: 'from-[#1A4277] to-[#04608E]' },
                { icon: Zap,        titleKey: 'hero.card4Title', descKey: 'hero.card4Desc', gradient: 'from-[#04608E] to-[#1EC2D7]' },
              ].map((card, index) => (
                <motion.div
                  key={index}
            ...
            {/*
              Badge "+15 años de experiencia" alineado a la derecha del grid,
              pegado al borde inferior de la última columna.
            */}
            <motion.div
            ...
            >
              <div className="bg-gradient-to-r from-[#04608E] to-[#1A4277] text-white px-5 py-2.5 rounded-full shadow-lg whitespace-nowrap">
